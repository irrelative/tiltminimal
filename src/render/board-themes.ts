...
export const BOARD_THEMES: Record<BoardThemeId, BoardTheme> = {
  'mirror-match': {
    id: 'mirror-match',
    label: 'Mirror Match',
    backgroundTop: '#1f3835',
    backgroundMid: '#2f6658',
    backgroundBottom: '#17302d',
    glowPrimary: 'rgba(210, 255, 231, 0.22)',
    glowSecondary: 'rgba(255, 117, 82, 0.18)',
    guideMetalPrimary: '#d6fff1',
    guideMetalSecondary: '#52c6a6',
    guideRubberPrimary: '#ff8768',
    guideRubberSecondary: 'rgba(226, 74, 64, 0.9)',
    bumperColors: ['#b8f36b', '#57d5bd', '#ff8a6b'],
    bumperRing: '#efffe8',
    bumperCap: '#f8ffdc',
    bumperText: 'rgba(19, 48, 43, 0.94)',
    postMetalFill: '#e9fff6',
    postMetalRing: '#4bc2a2',
    postMetalCore: '#285e53',
    postRubberFill: '#f06d5d',
    postRubberRing: '#fff1db',
    postRubberCore: '#263b37',
    plungerLaneFill: 'rgba(15, 43, 39, 0.24)',
    plungerLaneStroke: 'rgba(145, 255, 222, 0.44)',
    plungerGuidePrimary: '#d9fff3',
    plungerGuideSecondary: '#45b99d',
    plungerBodyFill: '#efffe7',
    plungerBodyStroke: '#45aa91',
    plungerKnob: '#ff8068',
    standupLitFill: '#f6ffcf',
    standupFill: '#ff9a62',
    targetStroke: '#24463f',
    dropUpFill: '#f06d5d',
    dropDownFill: 'rgba(232, 255, 240, 0.4)',
    dropStroke: '#f4ffe6',
    saucerOccupiedFill: '#b8f36b',
    saucerFill: '#21453e',
    saucerCoreOccupied: '#f9ffe5',
    saucerCore: 'rgba(233, 255, 237, 0.32)',
    saucerRing: '#bafee8',
    spinnerFill: '#bafee8',
    spinnerStroke: '#1d433c',
    spinnerCap: '#f5ffe3',
    rolloverLitFill: '#b8f36b',
    rolloverFill: 'rgba(242, 255, 221, 0.2)',
    rolloverStrokeLit: '#f6ffe8',
    rolloverStroke: '#5ac6a8',
    flipperFill: '#ef735d',
    flipperStroke: '#f7ffe4',
    flipperCore: '#f7ffe4',
    ballFill: '#fbfff7',
    ballStroke: 'rgba(20, 49, 44, 0.28)',
    hudText: '#effff5',
    hudMuted: 'rgba(239, 255, 245, 0.82)',
    launchMeterTrack: 'rgba(239, 255, 245, 0.18)',
    launchMeterFill: '#ff8068',
    launchMeterStroke: '#8ee7cf',
    launchMarkerStroke: 'rgba(239, 255, 245, 0.78)',
    launchMarkerStrokeActive: 'rgba(255, 255, 255, 0.96)',
    launchMarkerFill: 'rgba(239, 255, 245, 0.1)',
  },
  classic: {
    id: 'classic',
    label: 'Classic',
